...
import com.ATMClient.gui.BusinessPanelCtr;
import com.ATMClient.gui.RegisterPanelCtr;
...
public class ClientStart extends Application {
    ...
    public static void initMainPanel() throws Exception{
        ...
        loader.setLocation(ClientStart.class.getResource("gui/MainPanel.fxml"));
    ...
    public static void initLoginPanel() throws Exception{
        FXMLLoader loader=new FXMLLoader();
        loader.setLocation(ClientStart.class.getResource("gui/LoginPanel.fxml"));
        AnchorPane Panel=loader.load();
        Scene scene=new Scene(Panel);
        stage.setTitle("账户登录");
        stage.setScene(scene);
    ...
    public static void initRegisterPanel() throws Exception{
        FXMLLoader loader=new FXMLLoader();
        loader.setLocation(ClientStart.class.getResource("gui/RegisterPanel.fxml"));
        AnchorPane Panel=loader.load();
    ...
    public static void initBusinessPanel(Account account) throws Exception{
        FXMLLoader loader=new FXMLLoader();
        loader.setLocation(ClientStart.class.getResource("gui/BusinessPanel.fxml"));
        AnchorPane Panel=loader.load();
